window.addEventListener('load', () => {
    let form = document.getElementById('edit-form'),
        ...
        original_email = email.defaultValue.slice(0,-1),
    ...
    enable = () => {
        if(password.value == '' && confirmPassword.value == ''){
            if(name.value.length >= 2 && email.value == original_email){
                submit.classList.remove('disabled');
            } else {
                submit.classList.add('disabled');
            };
        } else {
            if(name.value.length >= 2 && email.value == original_email && password.value.length >= 8 && password.value == confirmPassword.value){
                submit.classList.remove('disabled');
            } else {
                submit.classList.add('disabled');
            };
    ...
    email.addEventListener('input', event => {
        if(event.originalTarget.value != original_email){
